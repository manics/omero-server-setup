...
setuptools.setup(
    ...
    description="OMERO server setup and database management plugin",
    long_description=open("README.md").read(),
    long_description_content_type="text/markdown",
    license="GPLv2",
    url="https://github.com/manics/omero-server-setup",
    packages=["omero_server_setup", "omero.plugins"],
    setup_requires=["setuptools_scm"],
    install_requires=["omero-py>=5.6.0"],
    use_scm_version={"write_to": "omero_server_setup/_version.py"},
    classifiers=[
        "Environment :: Console",
