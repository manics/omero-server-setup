...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("OMERO4.4__0", True),
        ("OMERO5.1DEV__2", True),
        ("OMERO5.1DEV__10", True),
        ("OMERO100.100__100", True),
        ("OMERO-precheck.sql", False),
...
class TestDb(object):
    ...
    def test_init(self, sqlfile, dryrun):
        ...
        if sqlfile != "notprovided":
            ...
            omerosql = None
        args = self.Args(
            {"omerosql": omerosql, "rootpass": "rootpass", "dry_run": dryrun}
        )
    ...
    def test_sql_version_matrix(self):
        ...
        assert M == [
            [None, "./sql/psql/OMERO5.0__0/OMERO4.4__0.sql", None],
    ...
    def test_sql_version_resolve(self, vfrom):
        ...
        M = [
            [None, "4.0/3.0", "4.4/3.0", None, None],
    ...
    def test_psql(self):
        ...
        omero_database.db.run(
            "psql", psqlargs, capturestd=True, env={"PGPASSWORD": "pass"}
        ).AndReturn((b"", b""))
        self.mox.ReplayAll()
    ...
    def test_pgdump(self):
        ...
        db.get_db_args_env().AndReturn(self.create_db_test_params())
        omero_database.db.run(
            "pg_dump", pgdumpargs, capturestd=True, env={"PGPASSWORD": "pass"}
        ).AndReturn((b"", b""))
        self.mox.ReplayAll()
